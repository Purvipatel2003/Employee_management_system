...
import { DeveloperTask } from '../../Table/Task/DeveloperTask'
...
import { DeveloperWelcomePage } from './DeveloperWelcomePage'
import { useState,useEffect } from 'react'
import { Loader } from '../../Components/Loader/Loader';
import { UpdateTaskStatus } from '../../Table/Task/UpdateTaskStatus'
...
export const DeveloperDashboard = () => {
  ...
  return (
    ...
    <Routes>
        <Route path='/' element={<DeveloperWelcomePage/>}></Route> 
...
<Route path="ProjectTable" element={<ProjectTable/>}></Route>
        ...
        <Route path='DeveloperTask/TaskDetail/:id' element={<TaskDetail/>}></Route>
        <Route path='DeveloperTask/TaskDetail/UpdateTaskStatus/:id' element={<UpdateTaskStatus/>}></Route>
