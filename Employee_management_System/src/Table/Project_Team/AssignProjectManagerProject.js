...
export const AssignProjectManagerProject = () => {
        ...
        const getProject_teamData = async(e)=>{
          ...
          await axios.get(`http://localhost:4000/userByRoleId/626c3b9075332464bdbb6572`).then(res=>{
  ...
  return (
    ...
    <div class="form-group">
      ...
      <option value="select status">--- Select Project ---</option>
      {
    ...
    <div class="form-group">
      ...
      <option value="select status">--- Select User ---</option>
      {
        userList.map((user)=>{
          return(
